...
<style type="text/css">
  ...
  background: linear-gradient(to top ,  red, skyblue);
...
<h5> Pour les différentes visualisations, utiliser la barre de menu pour y accéder, Nous precisons qu'elles sont toutes dynamiques</h5><br>
